...
#include "solution_interfaces/msg/detail/goal_position__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const solution_interfaces::msg::GoalPosition & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  solution_interfaces::msg::GoalPosition & ros_message)
{
  // Member: pose_stamped
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = solution_interfaces::msg::GoalPosition;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const solution_interfaces::msg::GoalPosition *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<solution_interfaces::msg::GoalPosition *>(
    untyped_ros_message);
...
{
  return &solution_interfaces::msg::typesupport_fastrtps_cpp::_GoalPosition__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, solution_interfaces, msg, GoalPosition)() {
  return &solution_interfaces::msg::typesupport_fastrtps_cpp::_GoalPosition__handle;
}
