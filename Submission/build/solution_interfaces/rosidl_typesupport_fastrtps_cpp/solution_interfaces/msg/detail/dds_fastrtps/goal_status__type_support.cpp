...
#include "solution_interfaces/msg/detail/goal_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const solution_interfaces::msg::GoalStatus & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  solution_interfaces::msg::GoalStatus & ros_message)
{
  // Member: status
  cdr >> ros_message.status;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = solution_interfaces::msg::GoalStatus;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const solution_interfaces::msg::GoalStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<solution_interfaces::msg::GoalStatus *>(
    untyped_ros_message);
...
{
  return &solution_interfaces::msg::typesupport_fastrtps_cpp::_GoalStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, solution_interfaces, msg, GoalStatus)() {
  return &solution_interfaces::msg::typesupport_fastrtps_cpp::_GoalStatus__handle;
}
