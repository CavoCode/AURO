...
static const _RandomGoal_Request_type_support_symbol_names_t _RandomGoal_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, solution_interfaces, srv, RandomGoal_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, solution_interfaces, srv, RandomGoal_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, solution_interfaces, srv, RandomGoal_Request)() {
  return &::solution_interfaces::srv::rosidl_typesupport_c::RandomGoal_Request_message_type_support_handle;
}
...
static const _RandomGoal_Response_type_support_symbol_names_t _RandomGoal_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, solution_interfaces, srv, RandomGoal_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, solution_interfaces, srv, RandomGoal_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, solution_interfaces, srv, RandomGoal_Response)() {
  return &::solution_interfaces::srv::rosidl_typesupport_c::RandomGoal_Response_message_type_support_handle;
}
...
static const _RandomGoal_type_support_symbol_names_t _RandomGoal_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, solution_interfaces, srv, RandomGoal)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, solution_interfaces, srv, RandomGoal)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, solution_interfaces, srv, RandomGoal)() {
  return &::solution_interfaces::srv::rosidl_typesupport_c::RandomGoal_service_type_support_handle;
}
