...
static const _StringWithPose_type_support_symbol_names_t _StringWithPose_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, solution_interfaces, msg, StringWithPose)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, solution_interfaces, msg, StringWithPose)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, solution_interfaces, msg, StringWithPose)() {
  return &::solution_interfaces::msg::rosidl_typesupport_c::StringWithPose_message_type_support_handle;
}
