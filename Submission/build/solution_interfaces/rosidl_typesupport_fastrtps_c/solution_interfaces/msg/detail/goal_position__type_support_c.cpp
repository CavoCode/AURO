...
#include "solution_interfaces/msg/detail/goal_position__rosidl_typesupport_fastrtps_c.h"
...
using _GoalPosition__ros_msg_type = solution_interfaces__msg__GoalPosition;
  ...
  void * untyped_ros_message)
{
  ...
  _GoalPosition__ros_msg_type * ros_message = static_cast<_GoalPosition__ros_msg_type *>(untyped_ros_message);
  // Field name: pose_stamped
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_solution_interfaces__msg__GoalPosition(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GoalPosition__ros_msg_type * ros_message = static_cast<const _GoalPosition__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _GoalPosition__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_solution_interfaces__msg__GoalPosition(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_solution_interfaces
size_t max_serialized_size_solution_interfaces__msg__GoalPosition(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = solution_interfaces__msg__GoalPosition;
    is_plain =
      (
...
static size_t _GoalPosition__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_solution_interfaces__msg__GoalPosition(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, solution_interfaces, msg, GoalPosition)() {
