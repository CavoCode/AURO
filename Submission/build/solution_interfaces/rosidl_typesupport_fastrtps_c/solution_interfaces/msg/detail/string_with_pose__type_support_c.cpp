...
#include "solution_interfaces/msg/detail/string_with_pose__rosidl_typesupport_fastrtps_c.h"
...
using _StringWithPose__ros_msg_type = solution_interfaces__msg__StringWithPose;
...
size_t get_serialized_size_solution_interfaces__msg__StringWithPose(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _StringWithPose__ros_msg_type * ros_message = static_cast<const _StringWithPose__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _StringWithPose__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_solution_interfaces__msg__StringWithPose(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_solution_interfaces
size_t max_serialized_size_solution_interfaces__msg__StringWithPose(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = solution_interfaces__msg__StringWithPose;
    is_plain =
      (
...
static size_t _StringWithPose__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_solution_interfaces__msg__StringWithPose(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, solution_interfaces, msg, StringWithPose)() {
