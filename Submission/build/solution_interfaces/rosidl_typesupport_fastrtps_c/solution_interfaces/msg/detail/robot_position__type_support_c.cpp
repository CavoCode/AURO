...
#include "solution_interfaces/msg/detail/robot_position__rosidl_typesupport_fastrtps_c.h"
...
using _RobotPosition__ros_msg_type = solution_interfaces__msg__RobotPosition;
...
size_t get_serialized_size_solution_interfaces__msg__RobotPosition(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _RobotPosition__ros_msg_type * ros_message = static_cast<const _RobotPosition__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _RobotPosition__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_solution_interfaces__msg__RobotPosition(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_solution_interfaces
size_t max_serialized_size_solution_interfaces__msg__RobotPosition(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = solution_interfaces__msg__RobotPosition;
    is_plain =
      (
...
static size_t _RobotPosition__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_solution_interfaces__msg__RobotPosition(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, solution_interfaces, msg, RobotPosition)() {
