...
#include "solution_interfaces/msg/detail/goal_status__rosidl_typesupport_fastrtps_c.h"
...
using _GoalStatus__ros_msg_type = solution_interfaces__msg__GoalStatus;
...
size_t get_serialized_size_solution_interfaces__msg__GoalStatus(
  const void * untyped_ros_message,
...
static uint32_t _GoalStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_solution_interfaces__msg__GoalStatus(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_solution_interfaces
size_t max_serialized_size_solution_interfaces__msg__GoalStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _GoalStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_solution_interfaces__msg__GoalStatus(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, solution_interfaces, msg, GoalStatus)() {
