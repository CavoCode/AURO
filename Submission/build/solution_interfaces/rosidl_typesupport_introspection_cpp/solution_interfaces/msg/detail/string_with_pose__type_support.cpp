...
{
  new (message_memory) solution_interfaces::msg::StringWithPose(_init);
}

void StringWithPose_fini_function(void * message_memory)
{
  auto typed_message = static_cast<solution_interfaces::msg::StringWithPose *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember StringWithPose_message_member_array[2] = {
  {
    ...
    offsetof(solution_interfaces::msg::StringWithPose, text),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(solution_interfaces::msg::StringWithPose, pose),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers StringWithPose_message_members = {
  ...
  2,  // number of fields
  sizeof(solution_interfaces::msg::StringWithPose),
...
{
  return &::solution_interfaces::msg::rosidl_typesupport_introspection_cpp::StringWithPose_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, solution_interfaces, msg, StringWithPose)() {
  return &::solution_interfaces::msg::rosidl_typesupport_introspection_cpp::StringWithPose_message_type_support_handle;
}
