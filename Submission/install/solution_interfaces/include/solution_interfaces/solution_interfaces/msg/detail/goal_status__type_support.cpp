...
{
  new (message_memory) solution_interfaces::msg::GoalStatus(_init);
}

void GoalStatus_fini_function(void * message_memory)
{
  auto typed_message = static_cast<solution_interfaces::msg::GoalStatus *>(message_memory);
...
{
  return &::solution_interfaces::msg::rosidl_typesupport_introspection_cpp::GoalStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, solution_interfaces, msg, GoalStatus)() {
  return &::solution_interfaces::msg::rosidl_typesupport_introspection_cpp::GoalStatus_message_type_support_handle;
}
