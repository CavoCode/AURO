...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ItemAssessment_message_member_array[3] = {
  {
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(solution_interfaces::msg::ItemAssessment, goal_angle),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
