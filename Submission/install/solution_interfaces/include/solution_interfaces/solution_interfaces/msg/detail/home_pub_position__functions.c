...
solution_interfaces__msg__HomePubPosition__init(solution_interfaces__msg__HomePubPosition * msg)
{
  ...
  if (!geometry_msgs__msg__Point__init(&msg->point)) {
    solution_interfaces__msg__HomePubPosition__fini(msg);
    return false;
  }
  // angle
  return true;
...
solution_interfaces__msg__HomePubPosition__create()
{
  ...
  solution_interfaces__msg__HomePubPosition * msg = (solution_interfaces__msg__HomePubPosition *)allocator.allocate(sizeof(solution_interfaces__msg__HomePubPosition), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(solution_interfaces__msg__HomePubPosition));
  bool success = solution_interfaces__msg__HomePubPosition__init(msg);
  if (!success) {
...
solution_interfaces__msg__HomePubPosition__Sequence__init(solution_interfaces__msg__HomePubPosition__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  solution_interfaces__msg__HomePubPosition * data = NULL;

  if (size) {
    data = (solution_interfaces__msg__HomePubPosition *)allocator.zero_allocate(size, sizeof(solution_interfaces__msg__HomePubPosition), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = solution_interfaces__msg__HomePubPosition__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        solution_interfaces__msg__HomePubPosition__fini(&data[i - 1]);
      }
...
solution_interfaces__msg__HomePubPosition__Sequence__fini(solution_interfaces__msg__HomePubPosition__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      solution_interfaces__msg__HomePubPosition__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  solution_interfaces__msg__HomePubPosition__Sequence * array = (solution_interfaces__msg__HomePubPosition__Sequence *)allocator.allocate(sizeof(solution_interfaces__msg__HomePubPosition__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = solution_interfaces__msg__HomePubPosition__Sequence__init(array, size);
  if (!success) {
...
solution_interfaces__msg__HomePubPosition__Sequence__destroy(solution_interfaces__msg__HomePubPosition__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    solution_interfaces__msg__HomePubPosition__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
solution_interfaces__msg__HomePubPosition__Sequence__are_equal(const solution_interfaces__msg__HomePubPosition__Sequence * lhs, const solution_interfaces__msg__HomePubPosition__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!solution_interfaces__msg__HomePubPosition__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  solution_interfaces__msg__HomePubPosition__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(solution_interfaces__msg__HomePubPosition);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    solution_interfaces__msg__HomePubPosition * data =
      (solution_interfaces__msg__HomePubPosition *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!solution_interfaces__msg__HomePubPosition__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          solution_interfaces__msg__HomePubPosition__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!solution_interfaces__msg__HomePubPosition__copy(
