...
bool solution_interfaces__msg__goal_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("solution_interfaces.msg._goal_status.GoalStatus", full_classname_dest, 47) == 0);
  }
  solution_interfaces__msg__GoalStatus * ros_message = _ros_message;
  {  // status
...
PyObject * solution_interfaces__msg__goal_status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("solution_interfaces.msg._goal_status");
