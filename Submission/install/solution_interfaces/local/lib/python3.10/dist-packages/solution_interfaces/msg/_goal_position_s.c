...
bool solution_interfaces__msg__goal_position__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("solution_interfaces.msg._goal_position.GoalPosition", full_classname_dest, 51) == 0);
  }
  solution_interfaces__msg__GoalPosition * ros_message = _ros_message;
  {  // pose_stamped
...
{
  /* NOTE(esteve): Call constructor of GoalPosition */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("solution_interfaces.msg._goal_position");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "GoalPosition");
